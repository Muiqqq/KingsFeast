...
public class LoadingScreen extends ScreenAdapter {
    ...
    private void loadAssets() {
        ...
        kingsFeast.getAssetManager().load("kana_flat.png", Texture.class);
        kingsFeast.getAssetManager().load("puuro.png", Texture.class);
        kingsFeast.getAssetManager().load("spagetti_flat.png", Texture.class);
        kingsFeast.getAssetManager().load("keitto.png", Texture.class);
        kingsFeast.getAssetManager().load("kakku_flat.png", Texture.class);
